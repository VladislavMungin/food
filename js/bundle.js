...
function calc(){
    ...
    function setActiveClaass(selector,activeClass){
        ...
        elem.forEach(el=>{
            ...
            if(el.getAttribute('data-active')===localStorage.getItem('ratio')){
                el.classList.add(activeClass)
            }
        })
    }

    setActiveClaass('#gender div', 'calculating__choose-item_active');
    setActiveClaass('.calculating__choose_big div', 'calculating__choose-item_active');
        ...
        elem.forEach(el=>{
            el.addEventListener('click',(e)=>{
                if(e.target.getAttribute('data-active')){
                    ...
                    localStorage.setItem('ratio',+e.target.getAttribute('data-active'));
                } else{
